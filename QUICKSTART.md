...
All dependencies (pydantic-ai, openai, streamlit, etc.) are in requirements.txt.
...
### Option B: AWS CLI Configuration [PREFERRED]
...
4. **BEDROCK_MIGRATION.md** - Migration guide
5. **.env.example** - Environment variable template

### Modified Files (5):
1. **requirements.txt** - Added pydantic-ai
...
1. **Choose Your Default Provider**
   - Edit app.py to change default from "openai" to "bedrock"
